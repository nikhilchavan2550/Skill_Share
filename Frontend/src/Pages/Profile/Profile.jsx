  ...
  useEffect(() => {
    const getUser = async () => {
      ...
      try {
        ...
        // If viewing own profile, also update local user state to ensure it's in sync
    ...
    getUser();
  }, [username, user?.username]); // Depend on username and user.username to refresh when either changes
